"""
Download one shard of the DCLM corpus and tokenize with the GPT-OSS tokenizer (o200k_harmony).

GPT-OSS uses the o200k_harmony tokenizer. Since HuggingFace AutoTokenizer supports
openai/gpt-oss-20b, we use that as the tokenizer name.
"""
